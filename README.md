...
running sends it with empty parameters, which clears that mode's own settings;
the log says so when it happens. Once a mode has been seen, it is remembered
