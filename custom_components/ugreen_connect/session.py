...
def drawing(values: dict) -> bool:
    ...
    Public, and deliberately so: two things ask it. SessionTracker.update uses
    it to tell charge flowing from a port that is merely live, and the
    coordinator's poll uses it to decide how often to poll. Changing what it
    means changes both.
    """
